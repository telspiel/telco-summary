...
import com.noesis.telco.summary.manager.reader.MisFinalDlrReader;

@Configuration
@EnableKafka
public class MisDlrReaderConfig {
	...
	@Value("${kafka.consumer.group.id.dlr}")
	private String kafkaConsumerGroupId;

	@Value("${kafka.partitions.for.dlr.topic}")
	...
	@Bean
	public MisFinalDlrReader misFinalDlrReader() {
		return new MisFinalDlrReader(Integer.parseInt(maxPollRecordsSize));
	}
